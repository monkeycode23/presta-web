...
console.log("API BASE URL:", import.meta.env.VITE_ENVIROMENT  , API_BASE_URL , API_PROD_BASE_URL);
  
const uri = import.meta.env.VITE_ENVIROMENT  === "dev" ? API_BASE_URL : API_PROD_BASE_URL
// Instancia de axios
